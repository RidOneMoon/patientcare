...
//         <h2 className="text-3xl font-black mb-8 text-black">Login</h2>
...
export default function LoginPage() {
  ...
  // --- GOOGLE LOGIN (UPDATED TO SYNC WITH MONGODB) ---
  const handleGoogleLogin = async () => {
    const provider = new GoogleAuthProvider();
    try {
      const res = await signInWithPopup(auth, provider);
      ...
      // 1. Sync Google User with MongoDB
      // This ensures 'AKIB' (or whatever the Google name is) exists in your DB
